<%-- 
    Document   : guidance.jsp
    Created on : Mar 23, 2022, 10:37:13 PM
    Author     : admin
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container_form">
            <div class="bg_img">           
                <form action="guidance" method="post">
                    <table>
                        <tr>
                            <td>Name</td>
                            <td><input class="input" type="text" value="${name}" name="name" required></td>
                        </tr>
                       
                        <tr>
                            <td>Number</td>
                            <td><input class="input" type="text" value="${number}" name="number" minlength="10" maxlength="10" required></td>
                        </tr>
                        
                        <tr>
                            <td>Topic</td>
                            <td><input class="input" type="text"  value="${topic}" name="topic" required></td>
                        </tr>                      
