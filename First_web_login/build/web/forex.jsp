<%-- 
    Document   : forex
    Created on : Mar 24, 2022, 9:04:48 PM
    Author     : admin
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            .bg_img{
                width:95em;
                height:95vh;
                background-image:url("img/forex.jpeg");
    ...
    <body>
        ...
        <%            
            ...
            String currency_f = (String) session.getAttribute("currency_f");
            String currency_t = (String) session.getAttribute("currency_t");            
            ...
            <div class="bg_img">
                <form action="forex" method="post">
                    <table>
                        ...
                        <tr>
                            <td>Present currency</td>
                            <td><input class="input" value="${currency_f}" type="text" name="currency_f" required></td>                            
                        </tr>
                        <tr>
                            <td>Convert to Currency</td>
                            <td><input class="input" value="${currency_t}" type="text" name="currency_t" required></td>                            
                        </tr>
                    </table>
