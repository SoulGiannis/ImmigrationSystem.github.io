    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            try{                
                ...
                String country_applying = request.getParameter("country_applying");

                Connection con = ServicesDao.createConnection();
                PreparedStatement st = con.prepareStatement("insert into visa values(?,?,?)");

                st.setString(1,name);
                st.setString(2,citizenship);
                st.setString(3,country_applying);                
                
                
                st.executeUpdate();
            
                request.setAttribute("t_name", "visa");
